...
Future<void> handleAllowFullAccessDialog(WidgetTester tester) async {
  await Future.delayed(Duration(seconds: 2));
  
  final allowButtonFinder = find.byWidgetPredicate(
    (widget) =>
        widget is CupertinoDialogAction &&
        widget.child is Text &&
        (widget.child as Text).data == 'Allow Full Access',
  );

  if (allowButtonFinder.evaluate().isNotEmpty) {
    print("✅ Attempting to allow Full Access");
    await tester.tap(allowButtonFinder);
    await tester.pumpAndSettle();
  } else {
    print("❌ Allow Full Access button not found.");
  }
}
...
testWidgets("Should select Images from Albums", (WidgetTester tester) async {
  try {
    ...
    // Step 2: Handle Cupertino Dialog for "Allow Full Access"
    await handleAllowFullAccessDialog(tester);
...
// Helper Function 1: Handle the CupertinoDialogAction for "Allow Full Access"
...
//   // Find CupertinoDialogAction button based on the text
//       final allowButtonFinder = find.byWidgetPredicate(
//         (widget) =>
//             widget is CupertinoDialogAction &&
//             widget.child is Text &&
...
//         print("Allow Full Access button not found.");
//       }
//         print("✅ Allowed Full Access");


//         print("✅ Navigating to Gallery Screen");

//         // Verify GalleryScreen is displayed
//         expect(find.byType(GalleryScreen), findsOneWidget, 
//           reason: "Gallery Screen should be displayed when user navigates to Add Images Screen");
//         print("✅ Gallery Screen is displayed");

        
//         // Verify Gallery body is visible
//         expect(find.byKey(const Key('gallery_body')), findsOneWidget, 
//           reason: "Main body of Gallery should be opened on init");
//         print("✅ Gallery body is displayed");


//         print("Attempting to scroll");
//         // Scroll until album is visible
//         await tester.scrollUntilVisible(
//           find.text(DETECTION_TEST.emotion_test_album),
//           500.0, // Adjust scroll distance
//           scrollable: find.byType(Scrollable),
...
//         // Ensure the album is now visible
//         expect(find.text(DETECTION_TEST.emotion_test_album), findsOneWidget, 
//           reason: "Album should be visible before tapping");
...
//         // Verify the selected album is displayed in the AppBar
//         expect(find.widgetWithText(AppBar, DETECTION_TEST.emotion_test_album), findsOneWidget,
//           reason: "AppBar should display the selected album name");
//         print("✅ Selected album is displayed in the AppBar");
...
//           // Ensure the image is visible by scrolling
//           await tester.scrollUntilVisible(
//             imageFinder,
//             100.0, // Scroll amount per step (adjust if needed)
//             scrollable: find.byType(Scrollable), // Ensures it scrolls inside the GridView
//           );
//           await tester.pumpAndSettle();
...
//         surprise: 2,
//       );
//       print("✅ Run Prediction on test_album");
...
//       // Predicted Emotions model
//       print("✅ Counted all emotions");
//       Model_Benchmark pred_benchmark = Model_Benchmark(
//         albumName: DETECTION_TEST.emotion_test_album,
//         anger: angryCount,
//         disgust: disgustCount,
...
//       // Compare this count to the benchmark value
//       double accuracy = benchmark.compareAndAnalyzePredictions(pred_benchmark);
