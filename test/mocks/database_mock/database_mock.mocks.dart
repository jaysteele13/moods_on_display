...
// in moods_on_display/test/mocks/database_mock/database_mock.dart.
...
import 'package:moods_on_display/managers/services/services.dart' as _i7;
...
/// A class which mocks [GetDirectoryService].
///
/// See the documentation for Mockito's code generation for more information.
class MockGetDirectoryService extends _i1.Mock
    implements _i7.GetDirectoryService {
  MockGetDirectoryService() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i3.Future<_i4.Directory> getCurrentDirectory() =>
      (super.noSuchMethod(
            Invocation.method(#getCurrentDirectory, []),
